...
Follow the instructions below to set up pre-commit hooks _for all of your repos_. You can set up different hooks for individual repos, but I recommend setting this up globally so that all of your local clones are covered by the security hook.
...
10.  Check your git history (@sec-scan)
...
This is the easier way to scan _commit history_. 
