...
There are many more options for overwriting the git history, such as removing a file instead of just key words. See the documentation for more info: https://github.com/newren/git-filter-repo/tree/main#how-do-i-install-it
