...
Before contributing any code, please read our [security policies](security.qmd) and [collaboration guide](gh_collab_tutorial.qmd). There you will find our repo rules and instructions on how to set up pre-commit hooks and contributing how to contribute code.
...
Please see our [tutorial for more details.](newrepo.qmd)
