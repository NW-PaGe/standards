...
description: How to make your code reproducible
format: 
  html:
    code-fold: false
    code-overflow: wrap
...
Virtual Environments are another great way to make sure aspects of your repo are reproducible. They are commonly used to record package versions that the code/project uses. For more on virtual environments, [please see the venv guide.](renv.qmd)

# Github Releases

Github Releases make your code
